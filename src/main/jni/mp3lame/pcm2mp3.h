...
#include <jni.h>
/* Header for class com_fpliu_newton_base_audio_PCM2MP3 */

#ifndef _Included_com_fpliu_newton_base_audio_PCM2MP3
#define _Included_com_fpliu_newton_base_audio_PCM2MP3
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_fpliu_newton_base_audio_PCM2MP3
 * Method:    init
 * Signature: (IIII)Z
 */
