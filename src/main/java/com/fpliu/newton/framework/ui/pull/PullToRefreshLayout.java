package com.fpliu.newton.framework.ui.pull;
...
public class PullToRefreshLayout extends RelativeLayout {
	 ...
	 */
	public void refreshFinish(int refreshResult, String text) {
		...
		case SUCCEED:
			...
			refreshStateTextView.setText(text);
	 ...
	 *            PullToRefreshLayout.SUCCEED代表成功，PullToRefreshLayout.FAIL代表失败
	 */
	public void loadmoreFinish(int refreshResult, String text) {
		...
		case SUCCEED:
			...
			loadStateTextView.setText(text);
	...
	class MyTimer {
		...
		public MyTimer(Handler handler) {
			...
			timer = new Timer("PullToRefreshTimer");
		}
